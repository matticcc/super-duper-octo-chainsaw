#!/usr/bin/env python3
"""
Crazy Time A Telegram Bot — Render-compatible (Flask + gunicorn)
...
- Pinger (cron-job.org) hits / every 5 min to prevent Render free plan sleep
...
API_URL        = (
    ...
    "&isTopSlotMatched=true,false&tableId=CrazyTime0000002"
)
...
LOCK_PATH      = "/tmp/crazytime_a_bot_threads.lock"
...
@app.route("/")
def health():
    return "OK - Crazy Time A bot is running", 200

# ── Sector mappings (this API uses TitleCase names) ───────────────────────────
SECTOR_LABEL = {
    "1": "1", "one": "1",
    "2": "2", "two": "2",
    "5": "5", "five": "5",
...
def promo_loop():
    ...
    while True:
        ...
        text = '🎰 Play Crazy Time A on <a href="https://roobet.com/?ref=aittam">Roobet</a>'
